function Get-MT5OrderByGroup {
    ...
    $reqArgs = @{ Method = 'Get'; Path = "/api/v2/MT5/{tradePlatform}/OrderByGroup/$([uri]::EscapeDataString([string]$Mask))"; TradePlatform = $TradePlatform; Query = $q }
