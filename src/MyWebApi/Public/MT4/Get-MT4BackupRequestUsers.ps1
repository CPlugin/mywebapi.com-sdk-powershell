function Get-MT4BackupRequestUsers {
    <#
    .SYNOPSIS
    ...
    $reqArgs = @{ Method = 'Get'; Path = "/api/v2/MT4/{tradePlatform}/BackupRequestUsers/$([uri]::EscapeDataString([string]$File))"; TradePlatform = $TradePlatform; Query = $q }
