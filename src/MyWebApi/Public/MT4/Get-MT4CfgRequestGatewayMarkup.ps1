function Get-MT4CfgRequestGatewayMarkup {
    <#
    .SYNOPSIS
        List gateway markups
    #>
    [CmdletBinding()]
    param(
    ...
    $reqArgs = @{ Method = 'Get'; Path = "/api/v2/MT4/{tradePlatform}/CfgRequestGatewayMarkup"; TradePlatform = $TradePlatform; Query = $q }
